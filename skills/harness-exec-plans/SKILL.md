...
- `references/plan-architect-prompt.md`: plan-architect agent 系统提示词(Codex spawn_agent 用)
- `../harness-verification-loop/references/verification-loop-runner-prompt.md`: verification-loop-runner agent 系统提示词(Codex spawn_agent 用)
...
**Codex 用户**:通过 `spawn_agent` 工具使用,系统提示词见 `references/plan-architect-prompt.md`、`../harness-verification-loop/references/verification-loop-runner-prompt.md`。
