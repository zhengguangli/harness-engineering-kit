...
description: 为任意项目一键初始化 harness 结构——生成 AGENTS.md 地图、docs/ 骨架、.gitignore 规则。
model: sonnet
...
- **Write 仅用于创建新文件**:禁止使用 Write 修改现有业务代码、测试文件、或配置文件（package.json 等）。如果需要更新 .gitignore,使用 Bash 追加内容而非覆盖。
